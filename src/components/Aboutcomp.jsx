...
const Aboutcomp = () => {
  return (
    ...
    <div className='w-[1300px] py-[100px] m-auto about-wrapper'>
        ...
        <ul className='why'>
            <li className='about-item w-[250px] h-[300px] px-[45px] py-[40px] border-[1px] border-[#D9D9D9] rounded-xl'>
                <img src={About1} alt="" />
      ...
      <div className='flex items-center justify-between mt-[100px]'>
        <h1 className='font-[700] text-[40px] bg-[rgb(155, 155, 155)] leading-[54px] rounded-full catalog-title'>Популярные товары</h1>
        <button className='blog-btn flex items-center gap-[10px] border-[1px] border-[#454545] text-[#454545] rounded-[20px] w-[200px] py-[10px] pl-[45px]'>
          Все товары
          <img src={AllowRight} alt="Allow-right" />
        </button>
