...
const Catalog = () => {
  return (
        <div className='w-[1300px] py-[100px] m-auto catalog-2'>
            <div className='flex items-center justify-between mb-[53px]'>
                <h2 className='font-[700] text-[40px] leading-[54px] catalog-title'>Каталог</h2>
            ...
            <ul className='category'>
                <li className='w-[420px] py-[32px] px-[32px] flex items-center justify-between bg-[#F2F2F2] rounde-[12px] catalog-item'>
