    ...
    <div className='w-[1310px] py-[100px] m-auto'>
      {state.wishlist.length === 0 ? (
        <div className='flex flex-col justify-center items-center'>
          ...
          <button className='w-[250px] py-[10px] bg-[rgb(155, 155, 155)] rounded-full text-[20px] text-white rounded-lg cursor-pointer mr-[50px]' onClick={()=> navigate("/")}>Популярные товары</button>
        </div>
      ) : (
        <>  
